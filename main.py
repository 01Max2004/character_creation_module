...
def defence(char_name: str, char_class: str) -> str:
    ...
    return (f'{char_name} не смог заблокировать атаку')


def special(char_name: str, char_class: str) -> str:
    """Вычисляет парамтры специальной атаки."""
    if char_class == 'warrior':
    ...
    return (f'{char_name} не удалось применить'
...
def main() -> None:
    """Приветсвие, название, выбор персонажа"""
